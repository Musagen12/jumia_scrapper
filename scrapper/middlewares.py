...
class FakeUserAgentsMiddleware:
    ...
    # Gets the respective variables from the setting.py file when the class is initialized
    ...
    # This function gets the user agents(as a list) from scrapeops
    ...
    # Checks whether the random user agent is active
    ...
    # Attaches the user agent to the headers
    def process_request(self, request, spider):        
